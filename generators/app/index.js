...
//      this.copy('index.html', 'index.html');
      ...
      this.copy('app.spec.js', 'app.spec.js');
      this.copy('constants.js', 'constants.js');
      this.copy('index.js', 'index.js');

      this.directory('actions', 'actions');
      this.directory('components', 'components');
      this.directory('config', 'config');
      this.directory('reducers', 'reducers');
      this.directory('sass', 'sass');
      this.directory('selectors', 'selectors');
